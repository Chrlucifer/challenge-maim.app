...
export class Tab1Page {
  ...
  async sendToWhatsapp() {
    ...
    window.open(`https://api.whatsapp.com/send?phone=082213778045&text=${output}`, '_blank');
  ...
  async sendToTelegram() {
    ...
    window.open(`https://t.me/082213778045=${output}`, '_blank');
  }
  ...
  async sendToEmail() {
    ...
    const url = `mailto:yudhaardiansyach37@gmail.com?subject=Data&20Informasi&body=${output}`;
